...
# 读取ETF数据
df = pd.read_csv('C:/Users/xrt85/Desktop/3月22日课程资料/agentic_portfolio/data/etf_day_with_basic_2022_2025.csv')
...
print(f"下降趋势 ({len(downtrend)}只): {', '.join([r['name'] for r in downtrend])}")
